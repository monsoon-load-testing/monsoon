...
const uploadTestScript = (dirName) => {
  const params = {};
...
const kickoffStartingLambda = (dirName) => {
...
class StartCommand extends Command {
  async run() {
    const dirName = chooseTestDirectory();
    uploadTestScript(dirName);
    kickoffStartingLambda(dirName);
